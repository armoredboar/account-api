...
func TestCalculateHmacSha256(t *testing.T) {
	...
	actual := security.CalculateHmacSha256("sample data", "sample key")
...
func TestCalculateHmacSha256_NullKey(t *testing.T) {
	...
	actual := security.CalculateHmacSha256("sample data", "")
...
func TestCalculateHmacSha256_NullData(t *testing.T) {
	...
	actual := security.CalculateHmacSha256("", "sample key")
